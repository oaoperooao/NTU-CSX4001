...
fb <- as.character(readtext("./corpus/FB.txt"))
pin <-as.character(readtext("./corpus/Pinterest.txt"))
line <-as.character(readtext("./corpus/Line.txt"))
flickr<-as.character(readtext("./corpus/Flickr.txt"))
```
